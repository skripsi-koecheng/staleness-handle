...
run_case "Buff alpha=0.5 | Balanced | Unweighted" \
  "$base_config straggler-scenario='balanced' staleness-weighting-enabled=false wandb-run-name='buff-alpha05-balanced-unweighted'"

run_case "Buff alpha=0.5 | Slow Dominant | Unweighted" \
  "$base_config straggler-scenario='slow_dominant' staleness-weighting-enabled=false wandb-run-name='buff-alpha05-slow-unweighted'"

run_case "Buff alpha=0.5 | Fast Dominant | Unweighted" \
  "$base_config straggler-scenario='fast_dominant' staleness-weighting-enabled=false wandb-run-name='buff-alpha05-fast-unweighted'"
