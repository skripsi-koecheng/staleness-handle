...
run_case "Imme alpha=0.5 | Balanced | Unweighted" \
  "$base_config_alpha05 straggler-scenario='balanced' staleness-weighting-enabled=false dirichlet-alpha=0.5 wandb-run-name='imme-alpha05-balanced-unweighted'"

run_case "Imme alpha=0.5 | Balanced | Weighted" \
  "$base_config_alpha05 straggler-scenario='balanced' staleness-weighting-enabled=true staleness-weighting-mode='polynomial' staleness-exponent=0.25 dirichlet-alpha=0.5 wandb-run-name='imme-alpha05-balanced-weighted'"
